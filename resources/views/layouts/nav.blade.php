<header class="flex items-center justify-between bg-gray-300">
   <div class="level">
       <a href="/">
       ...
       <searchbar inline-template>
           ...
           >
               ...
               <button v-if="ResultsAreOpen" @click="ResultsAreOpen = false" tabindex="-1" class="opacity-50 fixed top-0 right-0 left-0 bottom-0 h-full w-full bg-black cursor-default"></button>
    ...
    <div>
        @if (Auth::guest())
                <a class="mr-2 bg-gray-100 rounded-full px-2 py-0.5 hover:no-underline hover:text-white hover:bg-gray-800"
                   href="/login">
                    Login
                </a>
        @else
        ...
        <div class="level">
            ...
            <avatar inline-template>
                ...
                <div class="absolute top-0 right-0">
                    <button @click="isOpen = !isOpen" class="block h-48 w-48 rounded-bl-full overflow-hidden border-gray-100 border-4 focus:outline-none focus:border-pink-700">
                        <img
...
{{--                    cloak div needed to change to div instead of button to override default cursor property what was not possible with cursor-default and button--}}
                    <div v-if="isOpen" @click="isOpen = false" class="fixed right-0 top-0 left-0 top-0 h-full w-full cursor-default"></div>
...
{{--    <nav class="flex fixed-top navbar navbar-expand-lg navbar-light bg-gray-200">--}}
{{--        <div class="w-full">--}}
{{--        <div class="">--}}
...
{{--                       role="button"--}}
{{--                       aria-expanded="false">--}}
{{--                        <img class="h-75 w-75 absolute top-0 right-0 border-white border-4 border-solid rounded-l-full"--}}
{{--                             src="{{ auth()->user()->avatar_path }}" alt="Picture">--}}
{{--                    </a>--}}
